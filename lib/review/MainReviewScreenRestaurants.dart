              ...
              Expanded(
                child: Row(
                  ...
                  children: List.generate(5, (i) {
                    ...
                    Widget star;
                    if (i < fullStars) {
                      star = Image.asset("assets/images/restaurants.png", width: 14, height: 14, color: filledStarColor);
                    } else if (i == fullStars && fraction >= 0.25) {
                      star = Stack(
                        children: [
                          Image.asset("assets/images/restaurants.png", width: 14, height: 14, color: emptyStarColor),
                          ClipRect(
                            child: Align(
                              alignment: Alignment.centerLeft,
                              widthFactor: fraction,
                              child: Image.asset("assets/images/restaurants.png", width: 14, height: 14, color: filledStarColor),
                            ),
                          ),
                        ],
                      );
                    } else {
                      star = Image.asset("assets/images/restaurants.png", width: 14, height: 14, color: emptyStarColor);
                    }
                    return Padding(
