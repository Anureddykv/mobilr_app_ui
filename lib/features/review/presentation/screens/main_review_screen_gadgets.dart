...
import 'package:starnest/features/review/presentation/screens/add_edit_review_screen.dart'; // For date formatting
...
class _MainReviewScreenGadgetsState extends State<MainReviewScreenGadgets> {
  ...
  Future<void> _fetchGadgetReviewDetails() async {
    ...
    setState(() {
      _gadgetDetails = GadgetReviewDetails(
        ...
        title: 'MODE SONNET',
        imageUrl:
            "https://images.unsplash.com/photo-1604364132841-2558652a8315?q=80&w=2070&auto=format&fit=crop",
        ...
        userReviews: [
          GadgetReview(
            ...
            ratingGiven: 4.3,
            reviewTitle: 'Solid build, great feel!',
            reviewText:
                'The build quality is exceptional, and typing on it is a dream. The customization options are a huge plus for enthusiasts. Worth every penny for the premium experience.',
            likes: 115,
            dislikes: 4,
            avatarUrl: "https://placehold.co/40x40/FFC0CB/000?text=RS",
          ),
          GadgetReview(
            id: 'r2',
            ...
            ratingGiven: 5.0,
            reviewTitle: 'An absolute masterpiece!',
            reviewText:
                'A masterpiece of design and functionality. The performance is outstanding, and the features are top-notch. Highly recommended for all gadget lovers!',
            likes: 250,
            dislikes: 1,
            avatarUrl: "https://placehold.co/40x40/ADD8E6/000?text=PK",
          ),
          GadgetReview(
            id: 'r3',
            ...
            ratingGiven: 3.5,
            reviewTitle: 'Decent, but a bit pricey',
            reviewText:
                'The keyboard is good, but it felt a bit expensive for what it offers. Worth it if you are a die-hard enthusiast.',
            likes: 45,
            dislikes: 12,
          ),
          GadgetReview(
            ...
            ratingGiven: 4.0,
            reviewTitle: 'A Solid Performer',
            reviewText:
                'Reliable keyboard for daily work and gaming. Not the flashiest, but it gets the job done consistently. The sound profile is very satisfying.',
            likes: 72,
            dislikes: 5,
            avatarUrl: "https://placehold.co/40x40/90EE90/000?text=VK",
          ),
        ],
      );
      _isLoading = false;
  ...
  void _handleReviewInteraction(String reviewId, bool isLikeButton) {
    setState(() {
      ...
      if (isLikeButton) {
        _reviewInteractionStatus[reviewId] = (currentStatus == true)
            ? null
            : true;
      } else {
        _reviewInteractionStatus[reviewId] = (currentStatus == false)
            ? null
            : false;
      }
    });
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Expanded(flex: 2, child: _buildRatingsSection()),
  ...
  Widget _buildReviewsList() {
    ...
    final itemCount = reviews.length > _initialReviewCount
        ? _initialReviewCount
        : reviews.length;
      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            ...
            border: Border(top: BorderSide(width: 1, color: Color(0xFF191919))),
          ),
          child: const Row(
          ...
          Row(
            children: [
              _buildLikeDislikeButton(
                filledIconPath:
                    "assets/images/thum_up.png", // FIXED: Correct icon paths
