...
import 'package:starnest/features/settings/presentation/screens/privacy_policy_screen.dart' hide dividerColor;
import 'package:starnest/core/utils/snackbar_utils.dart';

import 'package:starnest/features/notification/presentation/screens/notification_screen.dart' hide dividerColor, primaryTextColor, darkBackgroundColor;
import 'package:starnest/features/settings/presentation/screens/settings_screen.dart' hide darkBackgroundColor, primaryTextColor;
        ...
        InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                  bottom: BorderSide(
                      color: _showNotificationPreferences ? dividerColor : Colors.transparent, width: 1)),
            ),
            child: Row(
              children: [
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(color: value ? Colors.transparent : cardBackgroundColor, width: 1.5)),
        child: Stack(
