...
import 'onboarding_interests_screen_games.dart';

class OnboardingInterestsScreenBooks extends StatelessWidget {
  // GET AN INSTANCE OF THE CONTROLLER
  final OnboardingController controller = Get.find();

  OnboardingInterestsScreenBooks({super.key});

  @override
  Widget build(BuildContext context) {
    // FETCH DATA FROM THE CONTROLLER
    final interestData = controller.getSubInterestData('Books');
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            // --- 1. Non-Scrollable Header (Uses data from controller) ---
            Padding(
  ...
  // Widget builder for the "Skip" button
  ...
  // WIDGET BUILDER FOR NAVIGATION BUTTONS (USES CONTROLLER)
